# EntryMsg - is a network of programs for anonymous communication on the Internet based on the principle of communication through a user server, bypassing all metrics services, etc.
